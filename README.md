...
After obtaining credentialed access and downloading the official MIMIC-IV release from PhysioNet, we extracted and preprocessed the relevant tables to create the analysis-ready files used in this project: death_drg_870_872_Nov_iv.csv and lab_drg_870_872_Nov_iv.csv.
